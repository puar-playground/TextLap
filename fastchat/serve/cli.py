...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--conv-system-msg", type=str,
        default=(f"Given a caption describing the visual layout of an image. "
                 ...
                 f"Write the layout in the format: entity: [left, top, right, bottom]. "
                 f"Please ensure there are only 4 entries in each box. "),
        help="Conversation system message."
    )
